...
static const int64 MAX_MONEY = 110000000 * COIN; // SoftCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 1) / 250; // SoftCoin: Priority cutoff is 2 SoftCoin day / 250 bytes.
    }
